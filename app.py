...
st.set_page_config(page_title="Curso Básico de ML - INIBEP", layout="centered")
...
st.markdown("""Desarrollado por **INIBEP S.A.C.**  
Este curso interactivo te permitirá aprender Machine Learning de forma práctica y progresiva.""")
